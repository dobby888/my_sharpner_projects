...
//headers:they are used when we have an operation or a feature which is used repeatedly
//axios:axios is a tool which is used to communication for frontend to backend using network calls
//select correct url,select correct operation, enter the body in json format(in stringify) only, 
//url--->baseurl:flipkart.com/getproducts:route=>some code behind the scenes
//                           /buyproducts
//                           /sellproducts
//url--->baseurl/route
